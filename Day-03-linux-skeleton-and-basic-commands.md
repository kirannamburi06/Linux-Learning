...
I want you to run these commands in your linux terminal and see the output for yourself, so that you will get used to the terminal and running commands.

Try to explore more options through man pages and see differences in output.

Try to understand than just copy pasting commands.
